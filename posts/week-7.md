...
We ended up finding a common topic we both where interested in, which was, self-development. While the other two topics where okay, the brief objective works best with these type of integration on BlaBla, since it lets us create a tool to help with this in a more interactive and engaging way.
